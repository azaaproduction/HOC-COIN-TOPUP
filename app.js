...
'<h3>➕ CREATE EVENT</h3><div class="card"><input id="cName" placeholder="Event Name"><input id="cOrg" placeholder="Organizer"><input id="cDate" type="date"><input id="cTime" placeholder="Event Time"><input id="cGroup" value="Haven Of Ceylon"><input id="cBanner" placeholder="Banner Image URL"><input id="cT1" value="Main Team"><input id="cL1" type="number" value="10"><input id="cT2" value="Team 02"><input id="cL2" type="number" value="10"><button class="primary" id="createBtn">CREATE EVENT</button></div><h3>👨‍👩‍👧‍👦 FAMILY TASK</h3><div class="card"><button class="primary" id="familyTaskAdminBtn" style="width:100%">👨‍👩‍👧‍👦 OPEN FAMILY TASKS</button></div>';
